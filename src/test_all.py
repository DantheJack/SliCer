import os
import pytest
from pentadClass import pentadStruct, printAllWithRoles, printNothingButRoles
...
def test_RoleAttribution1():
    ...
    assert testFileListOfPentads[4].roles[2].type == "varDeclar"
    assert testFileListOfPentads[5].roles[0].type == "varDeclar"
    assert testFileListOfPentads[5].roles[1].type == "varDeclar"
    assert testFileListOfPentads[6].roles[0].type == "varDeclar"
    assert testFileListOfPentads[6].roles[1].type == "varDeclar"
    assert testFileListOfPentads[7].roles[0].type == "varDeclar"
    assert testFileListOfPentads[8].roles[0].type == "varDeclar"
    assert testFileListOfPentads[9].roles[0].type == "varDeclar"
    assert testFileListOfPentads[10].roles[0].type == "varDeclar"
    assert testFileListOfPentads[10].roles[1].type == "varDeclar"
    assert testFileListOfPentads[11].roles[0].type == "varDefine"
    assert testFileListOfPentads[11].roles[1].type == "varDeclar"
    assert testFileListOfPentads[11].roles[2].type == "varDeclar"
    assert testFileListOfPentads[11].roles[3].type == "varDeclar"
    assert testFileListOfPentads[12].roles[0].type == "varDefine"
    assert testFileListOfPentads[13].roles[0].type == "varDefine"
    assert testFileListOfPentads[14].roles[0].type == "varDefine"
    assert testFileListOfPentads[15].roles[0].type == "varDeclar"
    assert testFileListOfPentads[15].roles[1].type == "varDeclar"
    assert testFileListOfPentads[15].roles[2].type == "varDeclar"
    assert testFileListOfPentads[15].roles[3].type == "varDeclar"
    assert testFileListOfPentads[16].roles[0].type == "varDeclar"
    assert testFileListOfPentads[16].roles[1].type == "varDeclar"
    assert testFileListOfPentads[16].roles[2].type == "varDeclar"
    assert testFileListOfPentads[16].roles[3].type == "varDeclar"
    assert testFileListOfPentads[17].roles[0].type == "ifCondition"
    assert testFileListOfPentads[18].roles[0].type == "ifBeg"
    assert testFileListOfPentads[19].roles[0].type == "varDefine"
    assert testFileListOfPentads[20].roles[0].type == "varDefine"
    assert testFileListOfPentads[21].roles[0].type == "varDefine"
    assert testFileListOfPentads[22].roles[0].type == "varDefine"
    assert testFileListOfPentads[23].roles[0].type == "loopCondition"
    assert testFileListOfPentads[23].roles[1].type == "varDefine"
    assert testFileListOfPentads[24].roles[0].type == "loopBeg"
    assert testFileListOfPentads[25].roles[0].type == "varDefine"
    assert testFileListOfPentads[26].roles[0].type == "ifCondition"
    assert testFileListOfPentads[27].roles[0].type == "ifBeg"
    assert testFileListOfPentads[28].roles[0].type == "varDefine"
    assert testFileListOfPentads[29].roles[0].type == "ifEnd"
    assert testFileListOfPentads[30].roles[0].type == "elseCondition"
    assert testFileListOfPentads[31].roles[0].type == "elseBeg"
    assert testFileListOfPentads[32].roles[0].type == "ifCondition"
    assert testFileListOfPentads[33].roles[0].type == "ifBeg"
    assert testFileListOfPentads[34].roles[0].type == "varDefine"
    assert testFileListOfPentads[35].roles[0].type == "ifEnd"
    assert testFileListOfPentads[36].roles[0].type == "elseCondition"
    assert testFileListOfPentads[37].roles[0].type == "elseBeg"
    assert testFileListOfPentads[38].roles[0].type == "ifCondition"
    assert testFileListOfPentads[39].roles[0].type == "ifBeg"
    assert testFileListOfPentads[40].roles[0].type == "varDefine"
    assert testFileListOfPentads[41].roles[0].type == "ifEnd"
    assert testFileListOfPentads[42].roles[0].type == "elseEnd"
    assert testFileListOfPentads[43].roles[0].type == "elseEnd"
    assert testFileListOfPentads[44].roles[0].type == "loopEnd"
    assert testFileListOfPentads[45].roles[0].type == "varDefine"
    assert testFileListOfPentads[46].roles[0].type == "ifCondition"
    assert testFileListOfPentads[47].roles[0].type == "ifBeg"
    assert testFileListOfPentads[48].roles[0].type == "varDefine"
    assert testFileListOfPentads[49].roles[0].type == "ifEnd"
    assert testFileListOfPentads[50].roles[0].type == "elseCondition"
    assert testFileListOfPentads[51].roles[0].type == "elseBeg"
    assert testFileListOfPentads[52].roles[0].type == "loopCondition"
    assert testFileListOfPentads[52].roles[1].type == "varDefine"
    assert testFileListOfPentads[53].roles[0].type == "loopBeg"
    assert testFileListOfPentads[54].roles[0].type == "ifCondition"
    assert testFileListOfPentads[55].roles[0].type == "ifBeg"
    assert testFileListOfPentads[56].roles[0].type == "varDefine"
    assert testFileListOfPentads[57].roles[0].type == "ifEnd"
    assert testFileListOfPentads[58].roles[0].type == "elseCondition"
    assert testFileListOfPentads[59].roles[0].type == "elseBeg"
    assert testFileListOfPentads[60].roles[0].type == "ifCondition"
    assert testFileListOfPentads[61].roles[0].type == "ifBeg"
    assert testFileListOfPentads[62].roles[0].type == "varDefine"
    assert testFileListOfPentads[63].roles[0].type == "ifEnd"
    assert testFileListOfPentads[64].roles[0].type == "elseCondition"
    assert testFileListOfPentads[65].roles[0].type == "elseBeg"
    assert testFileListOfPentads[66].roles[0].type == "ifCondition"
    assert testFileListOfPentads[67].roles[0].type == "ifBeg"
    assert testFileListOfPentads[68].roles[0].type == "varDefine"
    assert testFileListOfPentads[69].roles[0].type == "ifEnd"
    assert testFileListOfPentads[70].roles[0].type == "elseEnd"
    assert testFileListOfPentads[71].roles[0].type == "elseEnd"
    assert testFileListOfPentads[72].roles[0].type == "varDefine"
    assert testFileListOfPentads[73].roles[0].type == "loopEnd"
    assert testFileListOfPentads[74].roles[0].type == "elseEnd"
    assert testFileListOfPentads[75].roles[0].type == "ifEnd"
    assert testFileListOfPentads[76].roles[0].type == "elseCondition"
    assert testFileListOfPentads[77].roles[0].type == "elseBeg"
    assert testFileListOfPentads[78].roles[0].type == "varDefine"
    assert testFileListOfPentads[79].roles[0].type == "varDefine"
    assert testFileListOfPentads[80].roles[0].type == "varDefine"
    assert testFileListOfPentads[81].roles[0].type == "varDefine"
    assert testFileListOfPentads[82].roles[0].type == "varDefine"
    assert testFileListOfPentads[83].roles[0].type == "varDefine"
    assert testFileListOfPentads[84].roles[0].type == "varDefine"
    assert testFileListOfPentads[85].roles[0].type == "varDefine"
    assert testFileListOfPentads[86].roles[0].type == "ifCondition"
    assert testFileListOfPentads[87].roles[0].type == "ifBeg"
    assert testFileListOfPentads[88].roles[0].type == "varDefine"
    assert testFileListOfPentads[89].roles[0].type == "ifEnd"
    assert testFileListOfPentads[90].roles[0].type == "ifCondition"
    assert testFileListOfPentads[91].roles[0].type == "ifBeg"
    assert testFileListOfPentads[92].roles[0].type == "varDefine"
    assert testFileListOfPentads[93].roles[0].type == "ifEnd"
    assert testFileListOfPentads[94].roles[0].type == "elseCondition"
    assert testFileListOfPentads[95].roles[0].type == "elseBeg"
    assert testFileListOfPentads[96].roles[0].type == "ifCondition"
    assert testFileListOfPentads[97].roles[0].type == "ifBeg"
    assert testFileListOfPentads[98].roles[0].type == "varDefine"
    assert testFileListOfPentads[99].roles[0].type == "ifEnd"
    assert testFileListOfPentads[100].roles[0].type == "elseCondition"
    assert testFileListOfPentads[101].roles[0].type == "elseBeg"
    assert testFileListOfPentads[102].roles[0].type == "varDefine"
    assert testFileListOfPentads[103].roles[0].type == "elseEnd"
    assert testFileListOfPentads[104].roles[0].type == "elseEnd"
    assert testFileListOfPentads[105].roles[0].type == "ifCondition"
    assert testFileListOfPentads[106].roles[0].type == "ifBeg"
    assert testFileListOfPentads[107].roles[0].type == "loopCondition"
    assert testFileListOfPentads[107].roles[1].type == "varDefine"
    assert testFileListOfPentads[108].roles[0].type == "loopBeg"
    assert testFileListOfPentads[109].roles[0].type == "varDefine"
    assert testFileListOfPentads[110].roles[0].type == "loopEnd"
    assert testFileListOfPentads[111].roles[0].type == "varDefine"
    assert testFileListOfPentads[112].roles[0].type == "varDefine"
    assert testFileListOfPentads[113].roles[0].type == "varDefine"
    assert testFileListOfPentads[114].roles[0].type == "ifEnd"
    assert testFileListOfPentads[115].roles[0].type == "elseCondition"
    assert testFileListOfPentads[116].roles[0].type == "elseBeg"
    assert testFileListOfPentads[117].roles[0].type == "ifCondition"
    assert testFileListOfPentads[118].roles[0].type == "ifBeg"
    assert testFileListOfPentads[119].roles[0].type == "loopCondition"
    assert testFileListOfPentads[119].roles[1].type == "varDefine"
    assert testFileListOfPentads[120].roles[0].type == "loopBeg"
    assert testFileListOfPentads[121].roles[0].type == "varDefine"
    assert testFileListOfPentads[122].roles[0].type == "varDefine"
    assert testFileListOfPentads[123].roles[0].type == "varDefine"
    assert testFileListOfPentads[124].roles[0].type == "loopEnd"
    assert testFileListOfPentads[125].roles[0].type == "ifEnd"
    assert testFileListOfPentads[126].roles[0].type == "elseCondition"
    assert testFileListOfPentads[127].roles[0].type == "elseBeg"
    assert testFileListOfPentads[128].roles[0].type == "loopCondition"
    assert testFileListOfPentads[129].roles[0].type == "loopBeg"
    assert testFileListOfPentads[130].roles[0].type == "varDefine"
    assert testFileListOfPentads[131].roles[0].type == "varDefine"
...
def test_slice16():
    ...
    assert testFileListOfPentads[35].useful == True
    assert testFileListOfPentads[36].useful == False
...
def test_slice15():
    ...
    #    utility = 0
    #    for o in range (len(testFileListOfPentads)):
    #        if (testFileListOfPentads[o].useful and testFileListOfPentads[o].lines[0] <= x and x <= testFileListOfPentads[o].lines[1]):
    #            utility = 1
    #    if (utility == 1):
    #        print(" --> " + "[ " + str(x) + " ]\t" + line)
    #    else :
    ...
    assert testFileListOfPentads[0].text == "main ( )"
    assert testFileListOfPentads[0].useful == False
    assert testFileListOfPentads[1].useful == False
    assert testFileListOfPentads[2].useful == True
    ...
    assert testFileListOfPentads[40].useful == False
    assert testFileListOfPentads[41].useful == False
    assert testFileListOfPentads[42].useful == False
    assert testFileListOfPentads[43].useful == False
    assert testFileListOfPentads[44].useful == False
    assert testFileListOfPentads[45].useful == False
    assert testFileListOfPentads[46].useful == False
    assert testFileListOfPentads[47].useful == False
    assert testFileListOfPentads[48].useful == False
    assert testFileListOfPentads[49].useful == False
    assert testFileListOfPentads[50].useful == False
    assert testFileListOfPentads[51].useful == False
    assert testFileListOfPentads[52].useful == False
    assert testFileListOfPentads[53].useful == False
    assert testFileListOfPentads[54].useful == False
    assert testFileListOfPentads[55].useful == False
    assert testFileListOfPentads[56].useful == False
    assert testFileListOfPentads[57].useful == False  
    assert testFileListOfPentads[58].useful == False  
    assert testFileListOfPentads[59].useful == False  
    assert testFileListOfPentads[60].useful == False  
    assert testFileListOfPentads[61].useful == False  
    assert testFileListOfPentads[62].useful == False 
    assert testFileListOfPentads[63].useful == False  
    assert testFileListOfPentads[64].useful == False  
    assert testFileListOfPentads[65].useful == False  
    assert testFileListOfPentads[66].useful == False 
    assert testFileListOfPentads[67].useful == False  
    assert testFileListOfPentads[68].useful == False 
    assert testFileListOfPentads[69].useful == False  
    assert testFileListOfPentads[70].useful == False   
    assert testFileListOfPentads[71].useful == False  
    assert testFileListOfPentads[72].useful == False 
    assert testFileListOfPentads[73].useful == False  
    assert testFileListOfPentads[74].useful == True 
    assert testFileListOfPentads[75].useful == True  
    assert testFileListOfPentads[76].useful == True  
    assert testFileListOfPentads[77].useful == True 
    assert testFileListOfPentads[78].useful == True  
    assert testFileListOfPentads[79].useful == True 
    assert testFileListOfPentads[80].useful == False   
    assert testFileListOfPentads[81].useful == True  
    assert testFileListOfPentads[82].useful == False  
    assert testFileListOfPentads[83].useful == False 
    assert testFileListOfPentads[84].useful == False  
    assert testFileListOfPentads[85].useful == True 
    assert testFileListOfPentads[86].useful == True  
    assert testFileListOfPentads[87].useful == True  
    assert testFileListOfPentads[88].useful == True 
    assert testFileListOfPentads[89].useful == True 
    assert testFileListOfPentads[90].useful == True   
    assert testFileListOfPentads[91].useful == True 
    assert testFileListOfPentads[92].useful == True  
    assert testFileListOfPentads[93].useful == True  
    assert testFileListOfPentads[94].useful == True  
    assert testFileListOfPentads[95].useful == True 
    assert testFileListOfPentads[96].useful == True  
    assert testFileListOfPentads[97].useful == True 
    assert testFileListOfPentads[98].useful == True  
    assert testFileListOfPentads[99].useful == True  
    assert testFileListOfPentads[100].useful == True 
    assert testFileListOfPentads[101].useful == True 
    assert testFileListOfPentads[102].useful == True 
    assert testFileListOfPentads[103].useful == True 
    assert testFileListOfPentads[104].useful == True 
    assert testFileListOfPentads[105].useful == True 
    assert testFileListOfPentads[106].useful == False 
    assert testFileListOfPentads[107].useful == False
    assert testFileListOfPentads[108].useful == False 
    assert testFileListOfPentads[109].useful == False 
    assert testFileListOfPentads[110].useful == False 
    assert testFileListOfPentads[111].useful == False 
    assert testFileListOfPentads[112].useful == True  
    assert testFileListOfPentads[113].useful == True
    assert testFileListOfPentads[114].useful == True  
    assert testFileListOfPentads[115].useful == True 
    assert testFileListOfPentads[116].useful == True 
    assert testFileListOfPentads[117].useful == True  
    assert testFileListOfPentads[118].useful == True 
    assert testFileListOfPentads[119].useful == True 
    assert testFileListOfPentads[120].useful == True 
    assert testFileListOfPentads[121].useful == True  
    assert testFileListOfPentads[122].useful == True 
    assert testFileListOfPentads[123].useful == False  
    assert testFileListOfPentads[124].useful == True  
    assert testFileListOfPentads[125].useful == True 
    assert testFileListOfPentads[126].useful == True  
    assert testFileListOfPentads[127].useful == True 
    assert testFileListOfPentads[128].useful == True 
    assert testFileListOfPentads[129].useful == True  
    assert testFileListOfPentads[130].useful == True   
    assert testFileListOfPentads[131].useful == True 
    assert testFileListOfPentads[132].useful == False 
    assert testFileListOfPentads[133].useful == False 
    assert testFileListOfPentads[134].useful == False  
    assert testFileListOfPentads[135].useful == True 
    assert testFileListOfPentads[136].useful == True  
    assert testFileListOfPentads[137].useful == True
    assert testFileListOfPentads[138].useful == True  
    assert testFileListOfPentads[139].useful == False 
    assert testFileListOfPentads[140].useful == False
    assert testFileListOfPentads[141].useful == False 
    assert testFileListOfPentads[142].useful == True 
    assert testFileListOfPentads[143].useful == True 
    assert testFileListOfPentads[144].useful == False 
    assert testFileListOfPentads[145].useful == True 
    assert testFileListOfPentads[146].useful == False 
